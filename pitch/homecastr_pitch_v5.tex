...
\setbeamertemplate{footline}{%
  \ifnum\thepage>1\relax%
    \hbox to \paperwidth{%
      \kern1em\includegraphics[height=0.35cm]{assets/homecastr-icon.png}\kern4pt{\scriptsize\href{https://homecastr.com}{\textcolor{hcGold}{Homecastr}}}%
      \hfill%
...
\centering
\begin{tikzpicture}
  \node[circle, inner sep=0pt, minimum size=1.8cm, path picture={
    \node at (path picture bounding box.center) {\includegraphics[width=1.8cm]{assets/dhl.jpg}};
  }] {};
\end{tikzpicture}\\[4pt]
...
\begin{tikzpicture}
  ...
  \node[circle, inner sep=0pt, minimum size=1.8cm, fill=hcCard] {};
\end{tikzpicture}\\[4pt]
