...
\begin{tikzpicture}
  ...
  \node[anchor=north, text width=5.2cm, align=center] at (3.1,4.9) {
    {\fontsize{28}{34}\selectfont\bfseries\color{hcGold} 150M+\\Parcels Online}\\[10pt]
    {\large\bfseries\color{hcText} Data Inflection}\\[8pt]
    {\scriptsize\color{hcMuted} County appraisal records are now\\digitized and bulk-accessible at scale.}
  };
\end{tikzpicture}
\end{center}
\end{column}
...
\begin{tikzpicture}
  ...
  \node[anchor=north, text width=5.2cm, align=center] at (3.1,4.9) {
    ...
    {\scriptsize\color{hcMuted} Property-level probabilistic forecasts\\became computationally practical in 2023.}
  };
\end{tikzpicture}
\end{center}
\end{column}
