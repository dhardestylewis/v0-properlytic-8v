...
\begin{tikzpicture}
  ...
  \node[anchor=north, text width=5.2cm, align=center] at (3.1,4.9) {
    {\fontsize{28}{34}\selectfont\bfseries\color{hcGold} 300bps\\Swing}
  };
  \node[anchor=north, text width=5.2cm, align=center] at (3.1,3.2) {
  ...
  \node[anchor=north, text width=5.2cm, align=center] at (9.9,4.9) {
    {\fontsize{28}{34}\selectfont\bfseries\color{hcGold} Diffusion\\Models}
  };
  \node[anchor=north, text width=5.2cm, align=center] at (9.9,3.2) {
...
\textsuperscript{3}{\raise.17ex\hbox{$\scriptstyle\sim$}}8K operators {\texttimes} \$99/mo {\texttimes} 10\% penetration, 8 metros. Annual revenue ceiling.}}
\end{center}
\end{frame}
...
\begin{tikzpicture}[
  ...
  \node[cell] at (9.2, 1.4) {National scale};
  % Customers row
