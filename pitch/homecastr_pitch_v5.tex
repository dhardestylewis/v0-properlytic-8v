...
\begin{tikzpicture}
  ...
  \node[anchor=north, text width=5.2cm, align=center] at (3.1,4.9) {
    ...
    {\scriptsize\color{hcMuted} Rates swung from 3\% to 8\% and back.\\Static estimates are useless.\\Buyers need forecast ranges.}
  };
\end{tikzpicture}
\end{center}
\end{column}
...
\begin{tikzpicture}
  ...
  \node[text=hcGold, font=\Large\bfseries, anchor=west] at (3.5, -1.4) {\$750K};
...
\textsuperscript{3}Bottom-up: {\raise.17ex\hbox{$\scriptstyle\sim$}}6,000 brokers, SFR operators, and investors across 5 metros {\texttimes} \$99/mo {\texttimes} 10\% capture. Year 3 ARR target (\$750K).}}
\end{center}
\end{frame}
