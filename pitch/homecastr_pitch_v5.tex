...
\begin{tikzpicture}
  ...
  \node[anchor=north, text width=5.2cm, align=center] at (9.9,1.9) {
    {\scriptsize\color{hcMuted} Property-level\\[3pt]probabilistic forecasts\\[3pt]are now proven at scale.}
  };
\end{tikzpicture}
\end{center}
...
\textsuperscript{3}{\raise.17ex\hbox{$\scriptstyle\sim$}}12K operators {\texttimes} \$99/mo {\texttimes} 10\% penetration, 10 metros. Annual revenue ceiling.}}
\end{center}
\end{frame}
...
\vspace{4pt}
\begin{center}
\mutedtext{\small Programmatic SEO \textbullet\ Broker-client sharing \textbullet\ Organic growth}
\end{center}
\end{frame}
...
\begin{itemize}\setlength{\itemsep}{6pt}
  \item \goldtext{\textbf{10 metros}}, 20M+ properties
