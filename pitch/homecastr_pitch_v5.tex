...
\vspace{16pt}
\begin{center}
\mutedtext{\small Public data in. Probabilistic forecasts out. No black box.}
\end{center}
\end{frame}
...
\textsuperscript{3}Bottom-up: {\raise.17ex\hbox{$\scriptstyle\sim$}}6,000 ICP entities across 5 metros {\texttimes} \$99/mo {\texttimes} 15\% capture. Year 3 target.}}
\end{center}
\end{frame}
...
\begin{tikzpicture}[scale=0.9]
  ...
  \node[font=\footnotesize\bfseries, text=hcMuted, anchor=south west] at (-0.2,2.1) {Reventure};
...
\vspace{6pt}
\mutedtext{\small \href{https://homecastr.com}{\textcolor{hcGold}{\textbf{homecastr.com}}} — Free. Live. Interactive.}
\end{center}
\end{frame}
