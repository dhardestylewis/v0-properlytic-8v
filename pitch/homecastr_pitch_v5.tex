...
\begin{tikzpicture}
  ...
  \node[font=\fontsize{28}{34}\selectfont\bfseries, text=hcGold, align=center, anchor=north, text width=5.5cm] at (3.1,5.0) {150M+\\Parcels Online};
  \node[font=\large\bfseries, text=hcText, anchor=north] at (3.1,3.1) {Data Inflection};
  \node[font=\scriptsize, text=hcMuted, align=center, anchor=north, text width=5.5cm] at (3.1,2.3) {County appraisal records are now\\digitized and bulk-accessible at scale.};
\end{tikzpicture}
\end{center}
\end{column}
\begin{column}{0.48\textwidth}
...
\begin{tikzpicture}
  \fill[hcCard, rounded corners=8pt] (0,0) rectangle (6.2,5.2);
  \node[font=\fontsize{28}{34}\selectfont\bfseries, text=hcGold, align=center, anchor=north, text width=5.5cm] at (3.1,5.0) {Diffusion\\Models};
  \node[font=\large\bfseries, text=hcText, anchor=north] at (3.1,3.1) {Now Feasible at Scale};
  \node[font=\scriptsize, text=hcMuted, align=center, anchor=north, text width=5.5cm] at (3.1,2.3) {Property-level probabilistic forecasts\\became computationally practical in 2023.};
\end{tikzpicture}
\end{center}
\end{column}
\end{columns}
...
\begin{tikzpicture}[scale=0.9]
  ...
  \node[font=\footnotesize\bfseries, text=hcMuted, anchor=north] at (-0.5,1.8) {Reventure};
...
\begin{itemize}\setlength{\itemsep}{8pt}
  ...
  \item \goldtext{\textbf{Broker-Client Loops}}\\\mutedtext{Agents share forecasts with clients}
  \item \goldtext{\textbf{Organic Growth}}\\\mutedtext{Free tool drives word-of-mouth}
\end{itemize}
\end{center}
\end{frame}
