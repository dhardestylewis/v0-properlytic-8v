...
\begin{tikzpicture}
  ...
  \node[anchor=north, text width=5.2cm, align=center] at (3.1,4.9) {
    {\fontsize{28}{34}\selectfont\bfseries\color{hcGold} 30-yr\\Low}\\[10pt]
    {\large\bfseries\color{hcText} Rate Uncertainty}\\[8pt]
    {\scriptsize\color{hcMuted} Rates doubled in 18 months.\\Buyers can't act without\\forward-looking forecasts.}
  };
\end{tikzpicture}
\end{center}
\end{column}
...
\textsuperscript{3}Bottom-up: {\raise.17ex\hbox{$\scriptstyle\sim$}}6,000 brokers, SFR operators, and investors across 5 metros {\texttimes} \$99/mo {\texttimes} 15\% capture. Year 3 ARR target.}}
\end{center}
\end{frame}
