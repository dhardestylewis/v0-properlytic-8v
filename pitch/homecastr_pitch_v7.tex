...
% Reset background template — setbeamercolor{background canvas} handles the fill
...
\href{https://homecastr.com}{\includegraphics[width=\linewidth,height=4.8cm,keepaspectratio=true]{assets/dashboard_screenshot.png}}
\end{column}
