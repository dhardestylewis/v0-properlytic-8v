...
\begin{tikzpicture}
  ...
  \node at (3.4,2.5) {%
    \begin{minipage}[c][4.2cm][c]{5.6cm}\centering
      {\fontsize{28}{30}\selectfont\bfseries\color{hcGold} 300bps}\par
      \vspace{6pt}
      {\large\bfseries\color{hcText} in our training data}\par
      \vspace{10pt}
      {\scriptsize\setlength{\baselineskip}{13pt}\color{hcMuted}
        Our model trained through rates surging\\from 3\% to 7\%+.\\It learned to price rate cycles.\\Others haven't.}
    \end{minipage}%
  };
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}
  ...
  \node at (3.4,2.5) {%
    \begin{minipage}[c][4.2cm][c]{5.6cm}\centering
      {\fontsize{22}{24}\selectfont\bfseries\color{hcGold} ML Forecasting}\par
      \vspace{6pt}
      {\large\bfseries\color{hcText} now feasible at scale}\par
      \vspace{10pt}
      {\scriptsize\setlength{\baselineskip}{13pt}\color{hcMuted}
        GPU costs dropped 10{\texttimes}.\\Training at 100M+ property scale\\is now within reach.}
    \end{minipage}%
  };
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}
  ...
  \node[font=\small, text=hcMuted, align=center] at (3.25,1.8) {Dashboard \& basic forecasts\\[10pt]Builds audience. Every chat trains the model.};
\end{tikzpicture}
\end{center}
\end{column}
...
{\small\color{hcMuted} Direct calls to Houston SFR operators. Word-of-mouth closes pilots.}
\end{center}
\end{column}
