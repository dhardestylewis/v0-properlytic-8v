...
\begin{tikzpicture}
  ...
  \node at (3.4,2.5) {%
    \begin{minipage}[c][4.2cm][c]{6.0cm}\centering
      {\fontsize{36}{40}\selectfont\bfseries\color{hcGold} 300bps}\par
      \vspace{14pt}
      {\small\setlength{\baselineskip}{15pt}\color{hcMuted}
        Rate swing baked into our training data.\\Our model learned to price rate cycles.\\Others weren't trained on this.}
    \end{minipage}%
  };
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}
  ...
  \node at (3.4,2.5) {%
    \begin{minipage}[c][4.2cm][c]{6.0cm}\centering
      {\fontsize{36}{40}\selectfont\bfseries\color{hcGold} ML Forecasting}\par
      \vspace{14pt}
      {\small\setlength{\baselineskip}{15pt}\color{hcMuted}
        Now feasible at property scale.\\GPU costs dropped 10{\texttimes}.\\Training on 100M+ properties is within reach.}
    \end{minipage}%
  };
\end{tikzpicture}
\end{center}
