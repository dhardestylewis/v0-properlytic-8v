...
\begin{tikzpicture}
  ...
  \node[anchor=north, text width=5.2cm, align=center] at (3.1,2.8) {
  ...
  \node[anchor=north, text width=5.2cm, align=center] at (9.9,4.9) {
    {\fontsize{28}{34}\selectfont\bfseries\color{hcGold} ML Forecasting}
  };
  \node[anchor=north, text width=5.2cm, align=center] at (9.9,2.8) {
