...
\centering
\href{https://homecastr.com}{\includegraphics[width=\linewidth,height=4.2cm,keepaspectratio=true]{assets/dashboard_screenshot.png}}
\end{column}
\begin{column}{0.34\textwidth}
\centering
\statbox{15\%}{median error\textsuperscript{\textasteriskcentered}}\\[14pt]
\statbox{4yr}{forecast horizon}\\[14pt]
\statbox{1M+}{lots forecasted}
\end{column}
\end{columns}

\slidetagline{\href{https://homecastr.com}{\textcolor{hcGold}{homecastr.com}} \textbar{} Houston metro. Live. Free. \quad {\tiny\textsuperscript{\textasteriskcentered}50th percentile, 4yr horizon}}
\end{frame}
