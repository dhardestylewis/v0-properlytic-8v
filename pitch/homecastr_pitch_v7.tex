...
\begin{tikzpicture}[scale=0.9]
  ...
  \node[inner sep=2pt, fill=hcCard, rounded corners=2pt] at (0.5,2.5)
    {\includegraphics[height=0.40cm]{assets/logo_reventure.png}};

  % Homecastr — golden quadrant (logo replaces text label)
  \node[anchor=south west] at (3.6,2.8) {\includegraphics[height=0.55cm]{assets/homecastr-logo-horizontal.png}};
