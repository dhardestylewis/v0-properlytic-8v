...
\begin{tikzpicture}
  ...
  \node[anchor=north, text width=5.2cm, align=center] at (3.1,3.0) {
    {\large\bfseries\color{hcText} rate swing}
  };
  \node[anchor=north, text width=5.2cm, align=center] at (3.1,2.1) {
  ...
  \node[anchor=north, text width=5.2cm, align=center] at (9.9,3.0) {
    {\large\bfseries\color{hcText} now feasible at scale}
  };
  \node[anchor=north, text width=5.2cm, align=center] at (9.9,2.1) {
    {\scriptsize\color{hcMuted}
...
\begin{tikzpicture}[
  ...
  % Center label
  \node[font=\large\bfseries, text=hcGold] at (0,0) {Intent Data Moat};
\end{tikzpicture}
\end{center}

\begin{center}
{\small\color{hcMuted}\textit{Intent data is the moat. No one else is building it.}}
\end{center}
\end{frame}
...
\begin{center}
{\goldtext{\textbf{Programmatic SEO}}}\\[8pt]
{\small\color{hcMuted} Neighborhood + forecast\\pages rank for long-tail\\real estate queries.}
\end{center}
\end{column}
\begin{column}{0.32\textwidth}
\begin{center}
{\goldtext{\textbf{Broker sharing}}}\\[8pt]
{\small\color{hcMuted} Agents share Homecastr's\\forecasts with clients.\\Organic word-of-mouth.}
\end{center}
\end{column}
\begin{column}{0.32\textwidth}
\begin{center}
{\goldtext{\textbf{Operator upsell}}}\\[8pt]
{\small\color{hcMuted} Free users convert to\\\$99/mo as they scale\\their portfolios.}
\end{center}
\end{column}
\end{columns}
...
\vspace{12pt}
\begin{center}
{\small\color{hcMuted}\textit{Free product is the distribution.}}
\end{center}
\end{frame}
