...
\mutedtext{Pre-Seed Deck \quad|\quad \the\year}
\end{center}
\vfill
\end{frame}
...
\begin{itemize}\setlength{\itemsep}{6pt}
  \item \textbf{Time exits}\\\mutedtext{with forward-looking data}
  \item \textbf{Underserved}\\\mutedtext{by enterprise tools}
  \item \textbf{Pay for edge}\\\mutedtext{over Zillow estimates}
\end{itemize}
\end{column}
\end{columns}
...
\begin{tikzpicture}
  ...
  \node[text=hcMuted, font=\small, align=left, anchor=west] at (3.5, 1.3) {TAM \\ (8M+ Investors)};
  ...
  \node[text=hcMuted, font=\small, anchor=west] at (3.5, -1.9) {Year 3 SOM};
\end{tikzpicture}
\end{center}

\vspace{4pt}
\begin{center}
\mutedtext{Target cities*: Houston, Atlanta, Phoenix, DFW, Charlotte.}
\end{center}
\end{frame}
...
\toprule
& \textbf{RealAI\textsuperscript{1}} & \textbf{HouseCanary\textsuperscript{2}} & \textbf{PropStream\textsuperscript{3}} & \goldtext{\textbf{Homecastr}} \\
\midrule
...
\vspace{2pt}
{\scriptsize
\textsuperscript{1}\href{https://realai.com}{realai.com}\quad
\textsuperscript{2}\href{https://housecanary.com}{housecanary.com}\quad
\textsuperscript{3}\href{https://smart-bricks.com}{smart-bricks.com}
}
...
\midrule
Free & \$0 & 50K+ & Lead Gen & Basic \\
\textbf{Operator} & \textbf{\$99/mo} & 1,700 & \textbf{\$2.0M} & \textbf{Bulk/API}\\
\bottomrule
\end{tabular}
\end{center}
}
