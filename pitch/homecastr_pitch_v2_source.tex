...
% ΓöÇΓöÇΓöÇ Theme & Colors ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
\usetheme{default}
...
% Homecastr brand palette ΓÇö matches website beige theme
...
% ΓöÇΓöÇΓöÇ Macros ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
\mutedtext{Pre-Seed Deck \quad|\quad \the\year}\\[8pt]
\mutedtext{\small Live Demo: \textcolor{hcGold}{\textbf{homecastr.com}}}
\end{center}
\vfill
\end{frame}


% ΓöÇΓöÇΓöÇ SLIDE 2: Problem ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
% ΓöÇΓöÇΓöÇ SLIDE 3: Solution ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
% ΓöÇΓöÇΓöÇ SLIDE 4: Product ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
\begin{frame}{Product}
\vspace{12pt}
\begin{columns}[T]
...
% ΓöÇΓöÇΓöÇ SLIDE 5: Our Moat ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
\begin{itemize}
  \item \goldtext{Data Asset}: Intention reveals buyer needs
  \item \goldtext{Switching Costs}: Transparency builds high-trust lock-in
  \item \goldtext{Network Effects}: Market begins to price against model
\end{itemize}
\end{frame}

% ΓöÇΓöÇΓöÇ SLIDE 6: Market Opportunity ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
% ΓöÇΓöÇΓöÇ SLIDE 7: Competitive Landscape ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
\toprule
& \textbf{RealAI} & \textbf{HouseCanary} & \textbf{PropStream} & \goldtext{\textbf{Homecastr}} \\
\midrule
\textbf{Model} & GenAI & ML & Database & \goldtext{\textbf{Diffusion}} \\
\textbf{Output} & Chat & AVM & Lists & \goldtext{\textbf{Forecasts}} \\
\textbf{Forecasts?} & No & Point & No & \goldtext{\textbf{Bands}} \\
\textbf{Explainable?} & No & No & No & \goldtext{Grounded LLM} \\
\textbf{Access} & Closed & Enterprise & Self-serve & \goldtext{\textbf{Self-serve}} \\
\textbf{Price} & High & Custom & \$99/mo & \goldtext{\textbf{Freemium}} \\
\bottomrule
\end{tabular}
\end{center}
}
...
\vspace{2pt}
{\scriptsize
\textsuperscript{1}\href{https://realai.com}{realai.com}\mutedtext{\textsuperscript{1}RealAI Corp (2024). \textsuperscript{2}HouseCanary AVM. \textsuperscript{3}PropStream (Stewart Title).}\href{https://smart-bricks.com}{smart-bricks.com}
}
...
% ΓöÇΓöÇΓöÇ SLIDE 8: Business Model ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
% ΓöÇΓöÇΓöÇ SLIDE 9: Go-to-Market ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
% ΓöÇΓöÇΓöÇ SLIDE 9: Traction ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
% ΓöÇΓöÇΓöÇ SLIDE 10: Team ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
\begin{frame}{Team}
\vspace{4pt}
...
\begin{itemize}\setlength{\itemsep}{3pt}
  \item \goldtext{M.S. Urban Planning}: Columbia
  \item \goldtext{B.S. Mathematics}: UT Austin
\end{itemize}
\end{column}
\end{columns}
\end{frame}

% ΓöÇΓöÇΓöÇ SLIDE 11: The Ask ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
\begin{frame}[c]
\vspace{4pt}
...
\vfill
\begin{center}
{\Large\bfseries\color{hcText} THANK YOU}\\[8pt]
\mutedtext{\small \textbf{Try the Alpha: homecastr.com}}
\end{center}
\end{frame}
