...
export function ChatPanel({ isOpen, onClose, onMapAction, forecastMode }: ChatPanelProps) {
    ...
    return (
        ...
        bottom-0 left-1/2 right-0 w-1/2 h-[calc(40dvh+4px)] max-h-[calc(40vh+4px)] md:left-0 md:w-auto md:h-full md:max-h-full md:right-auto rounded-tr-xl md:rounded-none
      `}
        >
            <div className="h-full flex flex-col glass-panel border-t md:border-t-0 md:border-r border-border rounded-tr-xl md:rounded-none">
                {/* Header */}
