...
export function ChatPanel({ isOpen, onClose, onMapAction, forecastMode }: ChatPanelProps) {
    ...
    return (
        ...
        bottom-0 left-1/2 right-0 w-1/2 h-[calc(40dvh+2px)] max-h-[calc(40vh+2px)] md:left-0 md:w-auto md:h-full md:max-h-full md:right-auto rounded-t-xl md:rounded-none
      `}
        >
